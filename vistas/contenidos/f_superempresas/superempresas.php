...
<div class="">
<div class="page-title"><div class="title_left"><h3>EMPRESAS</h3></div></div>
        ...
        <div class="x_panel">
		  ...
		  <div id="lista_pacientes">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title"><h2 id="titulo_empresa">Listado de Empresas</h2>
                  ...
                  <div class="x_content">
					...
					<div id="viewlistado">
						<div class="table-responsive">
						  <table class="table table-striped jambo_table bulk_action">
							<thead>
							  <tr class="headings"><th>&nbsp;</th><th class="column-title">Empresa</th><th class="column-title">Apellido</th><th class="column-title">C&eacute;dula</th><th class="column-title">Edad</th></tr>
							</thead>
							<tbody>
					...
					<div id="createlistado" class="form-horizontal form-label-left">
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nombre Empresa<span class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-12"><input type="text" id="empresa" name="empresa" class="form-control col-md-7 col-xs-12"></div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Ruc <span class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-12"><input type="text" id="ruc" name="ruc" class="form-control col-md-7 col-xs-12"></div>
						</div>
						<div class="form-group">
							<label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Dirección <span class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-12"><input id="direccion" class="form-control col-md-7 col-xs-12" type="text" name="direccion"></div>
						</div>
						<div class="form-group">
							<label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Código Postal</label>
							<div class="col-md-6 col-sm-6 col-xs-12"><input id="codpostal" class="form-control col-md-7 col-xs-12" type="text" name="codpostal"></div>
						</div>
						<div class="form-group">
							<label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Teléfono <span class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-12"><input id="telefono" class="form-control col-md-7 col-xs-12" type="text" name="telefono"></div>
						</div>
						<div class="ln_solid"></div>
						<div class="form-group">
							<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
							  <button type="submit" class="btn btn-success" id="guardar_nueva_empresa">Guardar</button>
							  <button class="btn btn-primary" type="button" id="cancelar_nueva_empresa">Cancel</button>
							</div>
						</div>
					</div>
...
<script src="<?php echo SERVERURL; ?>vistas/contenidos/f_superempresas/superempresas.js"></script>